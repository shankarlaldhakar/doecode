...
var NameForm = (0, _mobxReact.observer)(_class = function (_React$Component) {
    ...
    _createClass(NameForm, [{
        ...
        value: function autopopulate(event) {
            (0, _utils.doAjax)('GET', "services?action=autopopulate&repo=" + this.props.metadataStore.metadata.repository_link, this.parseLoadResponse);
        ...
        value: function handleSubmit() {
            (0, _utils.doAjax)('POST', 'services?action=save', this.parseSaveResponse, this.props.metadataStore.metadata);
        }
    }, {
